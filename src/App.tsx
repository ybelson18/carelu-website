...
import QuestionsApp from './pages/QuestionsApp'
...
// Prerender (SSR) renders the carelu.com version: the static HTML is what
// crawlers of carelu.com read. leadtrap.com only differs at / and /privacy, /terms.
...
/* Every route, shared by the browser entry (main.tsx, BrowserRouter) and the
   prerender entry (entry-server.tsx, StaticRouter). */
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/sources/questions" element={<QuestionsApp />} />
