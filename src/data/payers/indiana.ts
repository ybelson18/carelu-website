...
export const indianaPayers: Record<string, PayerConfig> = {
  'indiana-medicaid': {
    ...
    intakeGates: {
      ...
      authTurnaround: {
        value:
          'For fee-for-service members, the PA contractor is Acentra Health and the clock is federal-floor fast. From January 1, 2026 (BT2025165), Acentra must decide a standard request “within seven calendar days of the initial standard PA request,” extendable “up to an additional seven calendar days” only if the member or provider asks or Acentra requests more information; an urgent/expedited request must be decided “within 72 hours,” and “No pend (extension) time frame will be allowed for urgent/expedited FFS PA requests.” That matches 42 CFR 440.230(e). When Acentra pends a request for information, the clock restarts on receipt, and the information must arrive within 30 calendar days of the original request or “the request is systematically denied.” Reauthorization lead time is written down: submit new PA requests for continuation of ongoing services “at least 30 calendar days before the current authorization period expires,” and a denial or cut to a continuing service needs “at least 10 days’ notice plus three days’ additional mailing time.” Most IHCP ABA members are in managed care, where the module says to ask the MCE for its own time parameters — see the Anthem, CareSource and MHS guides (Indiana law gives MCEs a 48-business-hour clock).',
        status: 'verified',
        cites: [{ title: 'IHCP Bulletin BT2025165 — IHCP to comply with CMS-0057-F Jan. 1, 2026 (11/25/2025)', url: 'https://www.in.gov/medicaid/providers/files/bulletins/BT2025165.pdf' }, { title: 'IHCP — Prior Authorization module (PROMOD00012, v7.2, publ. Nov. 20, 2025)', url: 'https://www.in.gov/medicaid/providers/files/modules/prior-authorization.pdf' }, { title: '42 CFR 440.230(e) — Medicaid FFS prior authorization timeframes (eCFR)', url: 'https://www.ecfr.gov/current/title-42/section-440.230' }],
      },
