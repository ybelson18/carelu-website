...
export const michiganPayers: Record<string, PayerConfig> = {
  ...
  'unitedhealthcare-michigan': {
    ...
    treatmentPA: {
      value:
        'Required — "Prior authorization is required for ABA *(unless otherwise specified or mandated by contract or law)."',
      status: 'verified',
      cites: [
        { title: 'Optum ABA Supplemental Clinical Criteria (BH803ABASCC; annual review 8/2025, interim review 4/2026)', url: 'https://public.providerexpress.com/content/dam/ope-provexpr/us/pdfs/clinResourcesMain/autismABA/abaSCC.pdf' },
      ],
    ...
    deliveryRules: {
      ...
      noteSignature: {
        value:
          'Optum’s criteria require daily progress notes with place of service, start and stop time, who rendered the service, the specific service, who attended, interventions, and the licensure or credentials of those in the session, but do not state who must sign or by when.',
        status: 'unverified',
        cites: [
          { title: 'Optum ABA Supplemental Clinical Criteria (BH803ABASCC; annual review 8/2025, interim review 4/2026)', url: 'https://public.providerexpress.com/content/dam/ope-provexpr/us/pdfs/clinResourcesMain/autismABA/abaSCC.pdf' },
        ],
        verifyVia:
          'The UnitedHealthcare / Optum provider agreement and administrative guide documentation standards.',
        blocker: 'per-case',
      },
      placeOfService: {
        value:
