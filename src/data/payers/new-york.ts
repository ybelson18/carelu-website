...
export const newYorkPayers: Record<string, PayerConfig> = {
  'new-york-medicaid': {
    ...
    metaDescription:
      'How NYS Medicaid covers ABA — no prior authorization at the fee-for-service layer (a 2-year practitioner referral is the gate), the 2023 managed-care carve-in where every major plan does require PA, the 97153 cuts ($14.45 now, $9.63 from October 1, 2026), LBA-only billing, and the 5% supervision rule.',
    intro: [
    ...
    atGlance: [
      ...
      { label: 'Rates (per 15 min)', value: '97153: $14.45 (eff. 4/1/2026) → $9.63 from 10/1/2026 (FFS) · 97151/97152/97155/97156: $19.26 · group codes $3.31/member' },
    ...
    sections: [
      ...
      {
        h2: 'Rates: a single statewide schedule — and a 97153 cut every six months',
        body: [
          ...
          'The third step is now official. The August 2026 Medicaid Update states that, \u201cas authorized by the New York State (NYS) Enacted Budget for Fiscal Year 2026-2027, NYS Medicaid fee-for-service (FFS) will decrease the fee paid for\u201d technician-delivered 97153, and that \u201ceffective October 1, 2026, the reimbursement for CPT code 97153 will be reduced to $9.63/per unit\u201d \u2014 a further third off the $14.45 rate, and exactly half the pre-cut $19.26. No other ABA code changes: 97151, 97152, 97155 and 97156 stay at $19.26 and the group codes at $3.31 per member. The rate history for 97153 is therefore $19.26 before October 1, 2025; $16.85 from October 1, 2025; $14.45 from April 1, 2026; and $9.63 from October 1, 2026. When we checked on September 25, 2026, the eMedNY fee-schedule spreadsheet still carried its April 1, 2026 header, so the Medicaid Update is the controlling notice until the .xls is reissued. No change after October 1, 2026 has been announced in any 2026 Medicaid Update through August. The notice is written for FFS; MMC plans set their own rates by contract, so ask each plan whether and when it follows the FFS change.',
        ],
        cites: [
    ...
    faq: [
      ...
      { q: 'What does NY Medicaid pay for ABA?', a: 'A single statewide FFS rate per code: $19.26 per 15-minute unit for 97151/97152/97155/97156 and $3.31 per member for the group codes. Technician-delivered 97153 pays $14.45 from April 1, 2026 through September 30, 2026, and $9.63 from October 1, 2026 (NYS Medicaid Update, August 2026). MMC plans negotiate their own rates.' },
      { q: 'Did New York Medicaid change ABA rates on October 1, 2026, and when is the next change?', a: 'Yes, a cut. The August 2026 NYS Medicaid Update (Vol 42 No 9) says that, as authorized by the FY 2026-27 enacted budget, \u201ceffective October 1, 2026, the reimbursement for CPT code 97153 will be reduced to $9.63/per unit\u201d for fee-for-service. It is the third 97153 step: $19.26 before 10/1/2025, $16.85 from 10/1/2025, $14.45 from 4/1/2026, $9.63 from 10/1/2026. No other ABA code changed, and no later change had been announced in the 2026 Medicaid Updates through August. MMC plans pay by contract; ask each plan whether it follows the FFS cut.' },
  ...
  'cigna-new-york': {
    ...
    deliveryRules: {
      supervision: {
        value:
          '\u201cDirect case supervision (occurs concurrently with the delivery of direct treatment to the individual and consists of BCBA face-to-face with the individual and either the Registered Behavior Technician [RBT] or the Board Certified Assistant Behavior Analyst [BCaBA]) and indirect case supervision is consistent with the general accepted standard of care of one to two hours per ten hours of direct treatment,\u201d and \u201cwhen direct treatment is 10 hours per week or less, a minimum of one to two hours per week of direct case supervision is provided.\u201d EN0499 accepts a BCBA, LBA or independently licensed clinician with documented ABA training as the supervisor \u2014 but in New York only the LBA half of that counts: DFS conditions coverage on ABA being provided or supervised by an NYSED-licensed LBA, or a CBAA under LBA supervision, and NYSED says BCBA certification \u201cmay not be used as a license to practice in New York State.\u201d How many supervisees: Education Law \u00a7 8802 says \u201cno licensed behavior analyst shall supervise more than six certified behavior analyst assistants\u201d; Article 167 sets no numeric cap for unlicensed technicians (the six-per-LBA cap that counts unlicensed staff is a NY Medicaid rule, not a licensure one).',
        status: 'verified',
  ...
  'unitedhealthcare-new-york': {
    ...
    deliveryRules: {
      supervision: {
        value:
          '\u201cConsistent with CASP standards of care, direct case supervision is required 1\u20132 hours for every 10 hours of direct treatment per week.\u201d Technicians \u201cmust be under the applicable supervision of a BCBA or licensed behavioral health clinician\u201d and \u201cshould be registered behavior technicians (RBT) or another appropriately certified behavior technician as allowable by state mandate\u201d \u2014 and in New York the state mandate is the binding half of that clause: DFS conditions coverage on ABA being provided or supervised by an NYSED-licensed LBA, or a CBAA under LBA supervision, with BCBA certification alone insufficient. Article 167 also caps the assistant tier: “No licensed behavior analyst shall supervise more than six certified behavior analyst assistants” (Ed. Law § 8802). Optum also bars a common workaround: \u201cit is not recommended that parents serve in an RBT role,\u201d and a BCBA supervising a parent acting as RBT for their own child \u201cwould also be in violation of their ethics code.\u201d',
        status: 'verified',
