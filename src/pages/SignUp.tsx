  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-gray-500">Get started with Carelu in minutes</p>
      </div>
      ...
      <p className="text-xs text-gray-400 text-center mt-6">
        ...
        <a href="#" className="text-brand-500 hover:text-brand-600 no-underline">Terms of Service</a>
        {' '}and{' '}
        <a href="#" className="text-brand-500 hover:text-brand-600 no-underline">Privacy Policy</a>
      </p>
    </AuthLayout>
  );
}
